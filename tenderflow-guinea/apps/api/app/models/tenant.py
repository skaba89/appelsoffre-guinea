...
class Tenant(Base):
    ...
    sources = relationship("Source", back_populates="tenant", lazy="noload")
    tenders = relationship("Tender", back_populates="tenant", lazy="noload")
    company_profile = relationship("CompanyProfile", back_populates="tenant", uselist=False, lazy="noload")
    crm_accounts = relationship("CRMAccount", back_populates="tenant", lazy="noload")
